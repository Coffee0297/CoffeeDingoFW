...
/*
** =========================================================
** dingoPDM embedded overrides (STM32F446 / ChibiOS, bare-metal).
** No stdout/stderr on the target, so route Lua's print/error output
** to no-ops; diagnostics surface through the engine's InfoMsg path.
** =========================================================
*/
...
*/
#define LUA_32BITS	1	/* dingoPDM: 32-bit int + single-precision float for Cortex-M4F */
