...
CANTxMsg TxMsg0()
{
    ...
    stMsg.frame.data16[1] = (uint16_t)(GetTotalCurrent() * 10.0); // 0.1 A/bit
...
CANTxMsg TxMsg1()
{
    ...
    stMsg.frame.DLC = 8; // Bytes to send
    stMsg.frame.data16[0] = (uint16_t)(GetOutputCurrent(0) * 10.0); // 0.1 A/bit
    stMsg.frame.data16[1] = (uint16_t)(GetOutputCurrent(1) * 10.0);
    stMsg.frame.data16[2] = (uint16_t)(GetOutputCurrent(2) * 10.0);
    stMsg.frame.data16[3] = (uint16_t)(GetOutputCurrent(3) * 10.0);
...
CANTxMsg TxMsg2()
{
    ...
    stMsg.frame.DLC = 8; // Bytes to send
    stMsg.frame.data16[0] = (uint16_t)(GetOutputCurrent(4) * 10.0); // 0.1 A/bit
    stMsg.frame.data16[1] = (uint16_t)(GetOutputCurrent(5) * 10.0);
    stMsg.frame.data16[2] = (uint16_t)(GetOutputCurrent(6) * 10.0);
    stMsg.frame.data16[3] = (uint16_t)(GetOutputCurrent(7) * 10.0);
...
CANTxMsg TxMsg24()
{
    ...
    //=======================================================
    stMsg.frame.SID = stConfig.stDevice.nBaseId + CYCLIC_TX_OFFSET + 24;
    stMsg.frame.DLC = 8;
...
CANTxMsg TxMsg25()
{
    ...
    //=======================================================
    stMsg.frame.SID = stConfig.stDevice.nBaseId + CYCLIC_TX_OFFSET + 25;
    stMsg.frame.DLC = 8;
...
CANTxMsg TxMsg26()
{
    ...
    //=======================================================
    stMsg.frame.SID = stConfig.stDevice.nBaseId + CYCLIC_TX_OFFSET + 26;
    stMsg.frame.DLC = 8;
