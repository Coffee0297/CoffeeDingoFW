...
# 1..6 (368 KB) for the application (sector 7 holds the persistent config). The -O0 default image
# (~400 KB) does not fit; -Os brings it well under 368 KB. No FPU/float-ABI change.
