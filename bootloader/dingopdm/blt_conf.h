...
/* dingoFW: fallback XCP ids = PDM default base 0x0DE + 12/13. Overridden at runtime by
 * the base id the app passes in RAM (see can.c DingoLoadCanConfig). */
/** \brief Configure CAN message ID target->host. */
#define BOOT_COM_CAN_TX_MSG_ID          (0x0EB)
/** \brief Configure CAN message ID host->target. */
#define BOOT_COM_CAN_RX_MSG_ID          (0x0EA)
 ...
 *
 */
/** \brief Enable/disable USB transport layer. (CAN-only bootloader; USB-DFU is the
 *         separate STM32 ROM bootloader, entered by the app jumping to 0x1FFF0000.) */
